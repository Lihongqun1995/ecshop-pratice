...
return array(
	...
	'validate' => "
		...
		array('attr_type', 'require', '属性类别不能为空！', 1, 'regex', 3),
		array('attr_type', '唯一,可选', \"属性类别的值只能是在 '唯一,可选' 中的一个值！\", 1, 'in', 3),
	...
	'search' => array(
		...
		array('attr_type', 'in', '唯一-唯一,可选-可选', '', '属性类别'),
